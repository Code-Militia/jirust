...
impl DrawableComponent for HelpWidget {
...
// #[cfg(test)]
// mod test {
//     use super::{Color, CommandInfo, HelpWidget, KeyConfig, Modifier, Span, Spans, Style};
//
//     #[test]
//     fn test_get_text() {
//         let width = 3;
//         let key_config = KeyConfig::default();
//         let mut component = HelpWidget::new(key_config.clone());
//         component.set_cmds(vec![
//             CommandInfo::new(crate::widgets::commands::scroll(&key_config)),
//             CommandInfo::new(crate::widgets::commands::filter(&key_config)),
//         ]);
//         assert_eq!(
